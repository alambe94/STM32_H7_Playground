...
#define USBD_PID_HS     22648
#define USBD_PRODUCT_STRING_HS     "STM32 RNDIS+UVC"
#define USBD_CONFIGURATION_STRING_HS     "RNDIS+UVC Configuration"
#define USBD_INTERFACE_STRING_HS     "RNDIS+UVC Interface"
