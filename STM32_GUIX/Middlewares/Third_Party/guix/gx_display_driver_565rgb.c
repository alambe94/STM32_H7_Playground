...
__attribute__((section(".SD_RAM"))) static USHORT frame_buffer[STM32F746G_DISCO_SCREEN_WIDTH][STM32F746G_DISCO_SCREEN_HEIGHT];
...
/**************************************************************************/
static void stm32_565rgb_buffer_toggle(GX_CANVAS *canvas, GX_RECTANGLE *dirty)
{
GX_RECTANGLE    Limit;
GX_RECTANGLE    Copy;
ULONG           offset;
...
ULONG *put;
    ...
    if (gx_utility_rectangle_overlap_detect(&Limit, &canvas->gx_canvas_dirty_area, &Copy))
    {
        ...
        #if defined(GX_CHROMEART_ENABLE)
        gx_dma_init(DMA2D_M2M, (uint32_t) put, STM32F746G_DISCO_SCREEN_WIDTH - copy_width, copy_width, copy_height);  
        ...
        dest_stride_ulongs = STM32F746G_DISCO_SCREEN_WIDTH / 2;
...
UINT stm32_graphics_driver_setup_565rgb(GX_DISPLAY *display)
{
    ...
    */
    _gx_display_driver_565rgb_setup(display, (VOID*)LCD_SCREEN_HANDLE, stm32_565rgb_buffer_toggle);
