...
UINT stm32_graphics_driver_setup_24xrgb(GX_DISPLAY *graphic);
UINT stm32_graphics_driver_setup_565rgb(GX_DISPLAY *graphic);
...
GX_WINDOW_ROOT *root;
    ...
    gx_studio_display_configure(VGA_LCD, stm32_graphics_driver_setup_24xrgb,
