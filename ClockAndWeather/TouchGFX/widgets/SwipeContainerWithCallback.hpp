 ...
 */
class SwipeContainerWithCallback : public touchgfx::Container
{
public:
    SwipeContainerWithCallback();
    virtual ~SwipeContainerWithCallback();
    ...
    void setNewCenterAction(GenericCallback<bool>& callback);
    void setNewCenterCanceledAction(GenericCallback<>& callback);
...
private:
    ...
    GenericCallback<bool>* newCenterCallback;
    GenericCallback<>* newCenterCanceldCallback;
...
#endif // SWIPECONTAINERWITHCALLBACK_HPP
