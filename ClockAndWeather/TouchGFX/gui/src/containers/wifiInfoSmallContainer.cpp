...
void wifiInfoSmallContainer::setSignalStrength(uint16_t strength)
{
    ...
    case WIFI_STRENGTH::MINIMAL:
        signalStrengthIcon.setBitmap(Bitmap(BITMAP_WIFI_DOT_ID));
        break;

    case WIFI_STRENGTH::LOW:
        signalStrengthIcon.setBitmap(Bitmap(BITMAP_WIFI_LOW_ID));
        break;

    case WIFI_STRENGTH::MEDIUM:
        signalStrengthIcon.setBitmap(Bitmap(BITMAP_WIFI_MID_ID));
        break;

    case WIFI_STRENGTH::HIGH:
        signalStrengthIcon.setBitmap(Bitmap(BITMAP_WIFI_FULL_ID));
        break;
    }
