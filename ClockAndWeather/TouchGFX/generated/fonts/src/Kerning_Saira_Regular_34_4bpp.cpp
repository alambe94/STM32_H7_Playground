...
KEEP extern const touchgfx::KerningNode kerning_Saira_Regular_34_4bpp[] FONT_KERNING_LOCATION_FLASH_ATTRIBUTE =
{
    ...
    { 0x0074, -2 },  // (First char = [0x0074, t], Second char = [0x002E, period], Kerning dist = -2)
    ...
    { 0x00BF,  3 },  // (First char = [0x00BF, questiondown], Second char = [0x006A, j], Kerning dist = 3)
    ...
    { 0x004C, -3 },  // (First char = [0x004C, L], Second char = [0x201D, quotedblright], Kerning dist = -3)
