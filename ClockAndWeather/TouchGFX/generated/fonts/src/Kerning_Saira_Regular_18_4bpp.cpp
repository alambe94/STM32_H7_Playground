...
KEEP extern const touchgfx::KerningNode kerning_Saira_Regular_18_4bpp[] FONT_KERNING_LOCATION_FLASH_ATTRIBUTE =
{
    ...
    { 0x00BF,  2 },  // (First char = [0x00BF, questiondown], Second char = [0x006A, j], Kerning dist = 2)
