    ...
    wifiConnectingWifiRetryPressedCallback(this, &CloudAndWeatherViewBase::wifiConnectingWifiRetryPressedCallbackHandler)
{
    ...
    gradientBackground.setBitmap(touchgfx::Bitmap(BITMAP_AFTERNOON_ID));
    gradientBackground.setPosition(0, -1, 480, 272);
    gradientBackground.setOffset(0, 0);

    gradientBackground2.setBitmap(touchgfx::Bitmap(BITMAP_AFTERNOON_ID));
    gradientBackground2.setPosition(0, 0, 480, 272);
    gradientBackground2.setVisible(false);
    gradientBackground2.setOffset(0, 0);

    rightForecast.setPosition(0, 0, 480, 272);

    forecast3.setXY(0, 0);
    rightForecast.add(forecast3);

    centerForecast.setPosition(0, 0, 480, 272);

    forecast2.setXY(0, 0);
    centerForecast.add(forecast2);

    leftForecast.setPosition(0, 0, 480, 272);
