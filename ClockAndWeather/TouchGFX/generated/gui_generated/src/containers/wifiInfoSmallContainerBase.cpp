    ...
    flexButtonCallback(this, &wifiInfoSmallContainerBase::flexButtonCallbackHandler)
{
    ...
    wifiSSID.setPosition(10, 2, 151, 22);
    ...
    encryption.setPosition(10, 18, 151, 18);
    ...
    signalStrengthIcon.setXY(165, 8);
    signalStrengthIcon.setBitmap(touchgfx::Bitmap(BITMAP_WIFI_LOW_ID));
    ...
    listButtonOverlay.setPosition(0, 0, 195, 42);
